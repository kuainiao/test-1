...
class ManageRg
{
    public function manageRgUser($area,$uid,$server,$channel_type=1)
    {
		...
		$server_table = 'platform_rg_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_rg_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'ruigao'.$this->createRandString(6).$string;
			}
