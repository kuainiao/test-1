...
class ManageKL
{
    public function manageKLUser($area,$uid,$server,$channel_type=3)
    {
        //定义第三方平台类型
        $third_type = 9;
		
		$server_table = 'platform_kunlun_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_kunlun_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'kunlun'.$this->createRandString(6).$string;
			}
