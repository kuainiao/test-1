...
class ManageVivo
{
    public function manageVUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 24;
		$server_table = 'platform_vivo_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_vivo_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'vivo'.$this->createRandString(6).$string;
			}
