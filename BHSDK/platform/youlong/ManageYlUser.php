...
class ManageYl
{
    public function manageYlUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 25;
		
		$server_table = 'platform_youlong_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_youlong_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'yl'.$this->createRandString(6).$string;
			}
