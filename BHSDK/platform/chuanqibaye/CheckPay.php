...
require_once dirname(__FILE__).'/'.'../../models/CqbyIosModel.php';
    ...
    public function getReceiptData($accountId, $server, $receipt, $isSandbox, $userid, $nickname, $area_server)
    {
        ...
        if ($status == 0)
        {
            ...
            else
            {
                ...
                $insertPay = $newIos->insertIosPay($accountId , $server, $orderId, $quantity, $gameMoney, $purchaseDate, time());
                //写入充值log
