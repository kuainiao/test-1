...
class ManageMy
{
    public function manageMyUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 18;
		$server_table = 'platform_mumayi_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_mumayi_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'mumayi'.$this->createRandString(6).$string;
			}
