...
class ManageQh
{
    public function manageQhUser($area,$uid,$refresh='',$server='',$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 7;
		
		$server_table = 'platform_qh_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_qh_user';
        ...
        file_put_contents('/tmp/ba511', $dbUin.'_'.$gameDbUin);
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'qihu'.$this->createRandString(6).$string;
			}
