...
class ManageKy
{
    public function manageKyUser($area,$guid,$server,$channel_type=2)
    {
    	$uid = abs(crc32($guid));//因为其uid为字符串所以转码
    	
        //定义第三方平台类型
        $third_type = 12;
		
		$server_table = 'platform_ky_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_ky_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'ky'.$this->createRandString(6).$string;
			}
