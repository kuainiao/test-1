...
class Sdk{
	 ...
	 */
	private $AppId  = 7582513;//应用开发者appid
	private $Secretkey = 'GAGNTZNPtmtqetbp33QG5iHOXXftHIdl';//应用开发者Secretkey
	
	//订单查询接口地址
	private $OrderQueryUrl = "http://querysdkapi.91.com/CpOrderQuery.ashx";
	//登陆状态查询接口地址
	private $LoginStateUrl = "http://querysdkapi.baidu.com/query/cploginstatequery";
