 ...
 */
$AppId = 7582513; //应用开发者appid
$Secretkey = 'GAGNTZNPtmtqetbp33QG5iHOXXftHIdl';//应用开发者apKey
...
function notify_process($AppId,$Secretkey){
	...
	file_put_contents('/home/baiyutao/log/abc.txt',json_encode($inputParams));
	$connectorParam = "&";
	$spiltParam="=";
    ...
    {
        $newdb = new PlatModel();
        $selectOrderId = $newdb->selectNineOnePay($UID,$CooperatorOrderSerial,'platform_nineone_pay');
        //验证是否充值过
