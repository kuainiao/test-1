...
class ManageYx
{
    public function manageYxUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 16;
		...
		$server_table = 'platform_youxin_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_youxin_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'youxin'.$this->createRandString(6).$string;
			}
