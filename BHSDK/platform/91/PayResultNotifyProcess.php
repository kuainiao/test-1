...
$MyAppId = 109594;
$MyAppKey = '8680c372734faa2422eab9906a04c7a9b2dfa4761ad01ee6';
...
function pay_result_notify_process($MyAppId,$MyAppKey)
{
    ...
    if($sign_check == $Sign)
    {
        if ($PayStatus == 1)
        {
            ...
            {
                $sdkPaytime = time();
                $insert = $newdb->insertPay($Uin, $ConsumeStreamId, $CooOrderSerial, $GoodsId, $GoodsInfo, $GoodsCount, $OriginalMoney, $OrderMoney, $Note, $PayStatus, $CreateTime, $sdkPaytime);
                if($insert)
                {
                        ...
                        $newUser->insertUserpaylog($Uin, $thirdType, $CooOrderSerial, $sdkPaytime, $area, $Note, $OrderMoney, $accountId);
