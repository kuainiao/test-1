...
class ManageWdj
{
    public function manageWdjUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 6;
		
		$server_table = 'platform_wdj_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_wdj_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'wdj'.$this->createRandString(6).$string;
			}
