...
class ThreeJoySdk
{
	//private $gameId  = '100001';//填入3卓网分配的gameId
	...
	public function check_user_login($gameId, $area, $uid, $session,$server,$systemType=1)
    {
    	if($systemType==2){
    		//$this->gameId = '100001';
			$this->gameKey = 'fg2dynhuy3ihc5rwk5uo3sqhy71zhruz4wzfnrm2';
    	}
		$sign = md5($gameId.$uid.$session.$this->gameKey);
		$sourceString = "gameId=".$gameId."&uid=".$uid."&session=".$session."&sign=".$sign;
