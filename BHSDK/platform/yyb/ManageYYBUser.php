 ...
 */
require_once dirname(__FILE__).'/../../models/PlatModel.php';
require_once dirname(__FILE__).'/../../models/PlatToGameServerModel.php';
require_once dirname(__FILE__).'/../../models/UserLoginModel.php';

class ManageYYB
{
    public function manageYYBUser($area,$openid,$server,$channel_type=1)
    {
        $uid = abs(crc32($openid));
        //定义第三方平台类型
        $third_type = 28;

		$server_table = 'platform_yyb_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_yyb_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'yyb'.$this->createRandString(6).$string;
			}
