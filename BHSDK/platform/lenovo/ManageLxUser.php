...
class ManageLx
{
    public function manageLxUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 15;
		
		$server_table = 'platform_lenovo_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_lenovo_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'lenovo'.$this->createRandString(6).$string;
			}
