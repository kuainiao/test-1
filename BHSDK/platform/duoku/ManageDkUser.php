...
class ManageDk
{
    public function manageDkUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 4;
		
		$server_table = 'platform_duoku_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_duoku_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'dk'.$this->createRandString(6).$string;
			}
