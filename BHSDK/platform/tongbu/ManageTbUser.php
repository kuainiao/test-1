...
class ManageTb
{
    public function manageTbUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 10;
		
		$server_table = 'platform_tb_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_tb_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'tongbu'.$this->createRandString(6).$string;
			}
