...
class ManageJf
{
    public function manageJfUser($area,$uid,$server,$channel_type=1)
    {
        //定义第三方平台类型
        $third_type = 17;
		$server_table = 'platform_jifeng_server';
        //查询网站平台Uin
        $newdb = new PlatModel();
		$table = 'platform_jifeng_user';
        ...
        else
        {
            ...
            if($db_username!=''){
            	...
            	$wz_username = 'jifeng'.$this->createRandString(6).$string;
			}
