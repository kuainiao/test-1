...
class SendAlipay
{
    public function sendToAlipay($partner,$gameId, $uid, $orderMoney, $itemName, $cpInfo)
    {
        ...
        $alipay_config['partner']		= '2088011223173925';
        //nsky->2088011223173925
        //合作->2088511340144199

        //安全检验码，以数字和字母组成的32位字符
        //如果签名方式设置为“MD5”时，请设置该参数
        $alipay_config['key']			= 'fqgpmvwlhtl3x92pn8hr7chtcxnedm5n';
        ...
        $req_id = date('Ymdhis');
        //服务器异步通知页面路径
        $notify_url = "http://pfsdk.9sky.me/pay/alipay/notify_url.php";
        //页面跳转同步通知页面路径
        $call_back_url = "http://pfsdk.9sky.me/pay/alipay/call_back_url.php";
        //操作中断返回地址
        $merchant_url = "http://pfsdk.9sky.me/pay/alipay/call_back_url.php";
        //卖家支付宝帐户   公司-》16669667@qq.com，合作-》193977005@qq.com
        $seller_email = '16669667@qq.com';
        //商户订单号
        $today = date("Ymd");
