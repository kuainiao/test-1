...
<div class="warp">
  ...
  <div class="warp_box">
    ...
    <ul class="share">
          <li><a href="http://pfsdk.9sky.me/update_password.php">返回</a></li>
      </ul>
    </div>
    </div>
    </div>
...
require_once dirname(__FILE__).'/'.'sdk/ChangePass.php';

$username = $_POST['username'];
$oldPassword = $_POST['password1'];
$newPassword1 = $_POST['password2'];
$newPassword2 = $_POST['password22'];


$pfSdk = new Change();
echo $pfSdk->changePassword($username,$oldPassword,$newPassword1);
?>
            </span> </div>
