...
class IosModel extends Model
{
    ...
    {
        $db = $this->db;
        $insert = $db->insertTable('platform_ios_pay', array('NS_id'=>'', 'NS_account_id'=>$accountId, 'NS_server'=>$server, 'NS_order_id'=>$orderId, 'NS_quantity'=>$quantity, 'NS_game_money'=>$gameMoney, 'NS_purchase_date'=>$purchaseDate,'NS_sdk_pay_time'=>$sdkPayTime));
        return $insert;
    }
