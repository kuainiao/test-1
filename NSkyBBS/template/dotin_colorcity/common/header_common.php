...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--{csstemplate}-->
    <script type="text/javascript" src="$_G['style'][styleimgdir]/jquery1.42.min.js"></script>
    <script type="text/javascript" src="$_G['style'][styleimgdir]/jquery.SuperSlide.2.1.js"></script>
    ...
    <script type="text/javascript" src="$_G['style'][styleimgdir]/png.js" ></script>
     <script type="text/javascript">
     DD_belatedPNG.fix('.heart-icon, .i_qq, .i_wb, .scbar_type_td #scbar_type, .scbar_btn_td');
    </script>
    <![endif]-->