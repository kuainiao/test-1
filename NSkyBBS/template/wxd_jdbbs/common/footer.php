...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp cl">
		...
		<div id="frt">
			<p>Powered by 1<strong><a href="http://www.discuz.net" target="_blank">Discuz</a><a href="http://xiangni.com" target="_blank">!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--></p>
<!---*敬告：免费用户需保留下面【薇晓朵网络工作室】的版权连接，如需去除或商业用途，请购买商业授权! 为避免不必要的麻烦，请参考【版权声明 http:/www.Weixiaoduo.com/copyright】版权所有 (c) 2012-2013 保留所有权利。 *--->
			<p class="xs0">Copyright &copy; 2013-2014</p>
		</div>
		<!--{eval updatesession();}-->
