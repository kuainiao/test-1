...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'dbpfbbs';
$_config['db']['1']['dbuser'] = 'pfuser';
$_config['db']['1']['dbpw'] = "pfuser.!@#%$^";
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'pfbbs';
$_config['db']['1']['tablepre'] = 'pf_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

$_config['db']['2']['dbhost'] = 'dbsdkdb';
$_config['db']['2']['dbuser'] = 'pfuser';
$_config['db']['2']['dbpw'] = "pfuser.!@#%$^";
$_config['db']['2']['dbcharset'] = 'utf8';
$_config['db']['2']['pconnect'] = '0';
$_config['db']['2']['dbname'] = 'sdkdb';
$_config['db']['2']['tablepre'] = 'sdk_';
$_config['db']['map']=array('user'=>'2');
 
// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = '6vHMBU_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'Cr12_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '1b58e1hmQmqqaVsd';
