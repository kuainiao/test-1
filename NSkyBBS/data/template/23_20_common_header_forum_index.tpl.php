...
0
|| checktplrefresh('./template/wxd_jdbbs/common/header.htm', './template/default/common/header_common.htm', 1429525312, '20', './data/template/23_20_common_header_forum_index.tpl.php', './template/wxd_jdbbs', 'common/header_forum_index')
|| checktplrefresh('./template/wxd_jdbbs/common/header.htm', './template/default/common/header_qmenu.htm', 1429525312, '20', './data/template/23_20_common_header_forum_index.tpl.php', './template/wxd_jdbbs', 'common/header_forum_index')
|| checktplrefresh('./template/wxd_jdbbs/common/header.htm', './template/default/common/pubsearchform.htm', 1429525312, '20', './data/template/23_20_common_header_forum_index.tpl.php', './template/wxd_jdbbs', 'common/header_forum_index')
;?>
...
<div class="wp">
<div class="hdc cl"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?>
                    <a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2><?php include template('common/header_userstatus'); ?></div>
...
<ul style="float:left;"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
</ul>
...
<td class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" style="width:42px;" class="pn pnc" value="true"><strong class="xi2">搜索</strong></button></td>
