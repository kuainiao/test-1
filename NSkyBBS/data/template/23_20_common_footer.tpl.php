...
<div id="frt">
<p>Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz</a><a href="http://xiangni.com" target="_blank">!</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p>
<!---*¾´¸æ£ºÃâ·ÑÓÃ»§Ğè±£ÁôÏÂÃæ¡¾Ş±Ïş¶äÍøÂç¹¤×÷ÊÒ¡¿µÄ°æÈ¨Á¬½Ó£¬ÈçĞèÈ¥³ı»òÉÌÒµÓÃÍ¾£¬Çë¹ºÂòÉÌÒµÊÚÈ¨! Îª±ÜÃâ²»±ØÒªµÄÂé·³£¬Çë²Î¿¼¡¾°æÈ¨ÉùÃ÷ http:/www.Weixiaoduo.com/copyright¡¿°æÈ¨ËùÓĞ (c) 2012-2013 ±£ÁôËùÓĞÈ¨Àû¡£ *--->
<p class="xs0">&copy; 2001-2014 ¼¼ÊõÖ§³Ö: <A href="http://www.weixiaoduo.com" target=_blank title="Ş±Ïş¶äÍøÂç¹¤×÷ÊÒ">Ş±Ïş¶äÍøÂç¹¤×÷ÊÒ</A> 
</p>
...
<?php } if($_G['member']['newprompt'] && $_GET['do'] != 'notice') { if(is_array($_G['member']['category_num'])) foreach($_G['member']['category_num'] as $key => $val) { $noticetitle = lang('template', 'notice_'.$key);?>h5n.shownotification('notice_<?php echo $key;?>', '<?php echo $_G['siteurl'];?>home.php?mod=space&do=notice&view=<?php echo $key;?>', '<?php echo avatar($_G[uid],small,true);?>', '<?php echo $noticetitle;?> (<?php echo $val;?>)', 'æœ‰æ–°çš„æé†’ï¼Œå¿«å»çœ‹çœ‹å§');
<?php } } ?>
}
</script>
