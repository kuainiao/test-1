...
block_get('10,9');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<style id="diy_style" type="text/css">#portal_block_9 { background-color:#ffffff !important;background-image:none !important;border:#cccccc 0px none !important;}#portal_block_9 .dxb_bc { color:#333333 !important;font-size:16px !important;}</style>
...
<a href="forum.php?mod=guide&amp;view=my" title="我的帖子" class="xi2">我的帖子</a><span class="pipe">|</span><a href="forum.php?mod=guide&amp;view=new" title="最新回复" class="xi2">最新回复</a><span class="pipe">|</span><a href="home.php?mod=space&amp;do=favorite&amp;view=me" title="收藏" class="xi2">收藏</a><span class="pipe">|</span><a href="home.php?mod=task" title="任务" class="xi2">任务</a><span class="pipe">|</span><a href="home.php?mod=medal" title="勋章" class="xi2">勋章</a>&nbsp;
</div>-->
<div class="quick-thread-box cl">
<study_addnew><a target="_blank" class="quick-thread btn-base" data-text="快速发帖" style="cursor:pointer;" title="快速发帖" onclick="showWindow('nav','forum.php?mod=misc&amp;action=nav')">我要发帖</a></study_addnew>
</div>
...
<?php } ?>
<!--[diy=diy_chart]--><div id="diy_chart" class="area"><div id="framewLo2q1" class="frame move-span cl frame-2-1"><div id="framewLo2q1_left" class="column frame-2-1-l"><div id="framewLo2q1_left_temp" class="move-span temp"></div><?php block_display('10');?></div><div id="framewLo2q1_center" class="column frame-2-1-r"><div id="framewLo2q1_center_temp" class="move-span temp"></div><?php block_display('9');?></div></div></div><!--[/diy]-->
<div class="mn">
...
</span><?php $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></h2>
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>子版块: <?php echo $forum['subforums'];?></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
<?php if(empty($forum['redirect'])) { ?><span class="xi2"><?php echo dnumber($forum['threads']); ?></span><span class="xg1"> / <?php echo dnumber($forum['posts']); ?></span><?php } ?>
