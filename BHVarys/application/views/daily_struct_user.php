...
$(function () {
        $('#container').highcharts({
            ...
            title: {
                text: <?php echo "'".$start_date.$sys.$chan.$ser."'"; ?>,
				...
				title:{text:'日期',align: 'high'},
                 categories:  [<?php foreach($last_7day_daily_return as $v) :?>
                    <?php
							...
							else if($v[0]['moneyid']==2)
						    {echo  "'"."11~~51"."'".",";
							}else if($v[0]['moneyid']==3)
						    {echo "'"."51~~101"."'".",";
							}else if($v[0]['moneyid']==4)
						    {echo "'"."101~~201"."'".",";
							}else if($v[0]['moneyid']==5)
						    {echo "'"."201~~501"."'".",";
							}else if($v[0]['moneyid']==6)
						    {echo "'"."501~~801"."'".",";
							}else if($v[0]['moneyid']==7)
						    {echo "'"."801~~1001"."'".",";
							}else if($v[0]['moneyid']==8)
						    {echo "'"."1001~~2001"."'".",";
							}else if($v[0]['moneyid']==9)
						    {echo "'"."2001~~5001"."'".",";
							}else if($v[0]['moneyid']==10)
						    {echo "'"."5001~~".$v[0]['money']."'".",";
							}
					?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 支付结构</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    时间：<input type="text" <img src="<?php echo $viewspath;?>/img/date.png" height="20" width="20" style="margin-left:2px;" value=<?php echo $start_date;?> autocomplete="off" onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"  id="start_date" name="start_date" class="lstime">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/daily_struct_user');?>/"+start_date+"/"+server+"/"+channel+"/"+system+"/";
                        });
                    </script>
                </div>
