        ...
        $('#container').highcharts({
            ...
            xAxis: {
				title:{text:'日期',align: 'high'},
                 categories:  [<?php foreach($last_6_month_return as $v) :?>
                     <?php echo "'".date('Y-m', $v[0]['date'])."',";?>
                     <?php endforeach;?>],
				labels: {
					rotation: 0,
					//align: 'right',
            ...
            series: [{
                name: '月新增用户',
                   data: [<?php foreach($last_6_month_return as $v) :?>
                       <?php echo $v[0]['number'].',';?>
                       <?php endforeach;?>],
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 月新增用户统计</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    开始时间：<input type="text" <img src="<?php echo $viewspath;?>/img/date.png" height="20" width="20" style="margin-left:2px;" value=<?php echo $start_date;?> autocomplete="off" onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM',alwaysUseStartDate:true})"  id="start_date" name="start_date" class="lstime">
                    结束时间：<input type="text" <img src="<?php echo $viewspath;?>/img/date.png" height="20" width="20" style="margin-left:2px;" value=<?php echo $stop_date;?> autocomplete="off" onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM',alwaysUseStartDate:true})"  id="stop_date" name="stop_date" class="lstime">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/month_return_user');?>/"+start_date+"/"+stop_date+"/"+server+"/"+channel+"/"+system+"/";
                        });
                    </script>
                </div>
