    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 游戏消耗</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            var date = $('#date').val();
                            window.location.href="<?php echo site_url('gindex/consume');?>/"+date+"/"+server+"/";
                        });
                    </script>
                </div>
            ...
            <div class="box-content">
                <table class="items table table-striped table-bordered table-condensed">
                    <thead>
                        <th id="yw1_c0">日期</th><th id="yw1_c2">消耗方式</th><th id="yw1_c3">购买玩家数</th><th id="yw1_c4">购买次数</th><th id="yw1_c5">花费的彩晶数</th>
                        <?php foreach($all_arr as $k=>$v) :?>
                            <tr><td id="yw1_c0"><?php echo $v['date'];?></td><td id="yw1_c2"><?php echo $v['consume_mode'];?></td><td id="yw1_c3"><?php echo $v['buy_user_num'];?></td><td id="yw1_c4"><?php echo $v['buy_times'];?></td><td id="yw1_c5"><?php echo $v['jewel'];?></td></tr>
                        <?php endforeach;?>
                    </thead>
                </table>
            </div>
