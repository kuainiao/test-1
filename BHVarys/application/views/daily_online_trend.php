...
$(function () {
        $('#container').highcharts({
            ...
            tooltip: {
                formatter: function () {
                return '<b>' +<?php echo "'".$start_date."'";?>+'<br/>'+this.x+':00  ' +this.series.name 
                    + ':' + this.y+'个';
				}
            },
            legend: {
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 用户</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/daily_online_trend');?>/"+start_date+"/"+server+"/";
                        });
                    </script>
                </div>
