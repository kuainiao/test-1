...
$(function () {
        $('#container').highcharts({
            ...
            title: {
                text: <?php echo "'".$sys.$chan.$are.$ser."'"; ?>,
                x: -20 //center
            },
		...
		$('#area').change(function(){
			...
			$.ajax({
					   ...
					   type: "post",
                       url: "/index.php/gindex/getserver",
                       data: "id="+ar,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 平均在线统计</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
					<select type="text" id="flat" name="flat" class="lstime">
				   ...
				   <select type="text" id="system" name="system" class="lstime">
					 ...
					 <select type="text" id="area" name="area" class="lstime">
                        <option value='0' selected>选择大区</option>
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/daily_average_online_user');?>/"+start_date+"/"+stop_date+"/"+server+"/"+flat+"/"+system+"/"+area+"/";
                        });
                    </script>
                </div>
			...
			<div class="box-content">
			 ...
			 <div class="box-content">
                <table class="items table table-striped table-bordered table-condensed">
                    <thead>
                        <th id="yw1_c0">日期</th><th id="yw1_c2">平均在线用户数</th>
                        <?php foreach($last_7day_daily_return as $k=>$v) :?>
                            <tr><td id="yw1_c0"><?php echo $v['date'];?></td><td id="yw1_c2"><?php echo $v['nums'];?></td></tr>
                        <?php endforeach;?>
                    </thead>
                </table>
            </div>
