        ...
        $('#container').highcharts({
            ...
            xAxis: {
				title:{text:'日期',align: 'high'},
                 categories:  [<?php foreach($time as $v) :?>
                     <?php echo "'".date('Y-m-d', $v)."',";?>
                     <?php endforeach;?>]
            },
            yAxis: {
               title: {
            ...
            series: [{
                name: '最高在线',
                data: [<?php foreach($pcu as $v) :?>
                       <?php echo $v[0]['number'].',';?>
					   
						<?php endforeach;?>]
			    }, {
                name: '平均在线',
                data: [<?php foreach($acu as $v) :?>
                       <?php echo floor($v[0]['number']/24).',';?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 玩家在线统计</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/dayily_pc_user');?>/"+start_date+"/"+stop_date+"/"+server;
                        });
                    </script>
                </div>
