...
<div class="row">
    ...
    <div class="box col-md-12">
		...
		<div class="box-header well">
             <h2><i class="glyphicon glyphicon-list-alt"></i> 当前在线玩家: <?php echo $numd; ?></h2>
		</div>
            <div class="box-content">
                <table class="items table table-striped table-bordered table-condensed">
                    <thead>
                        <th id="yw1_c0">游戏服</th><th id="yw1_c2">当前在线玩家</th>
                        <?php foreach($all_arr as $k=>$v) :?>
                            <tr><td id="yw1_c0"><?php echo $v['name'];?></td><td id="yw1_c2"><?php echo $v['number'];?></td></tr>
                        <?php endforeach;?>
                    </thead>
                </table>
            </div>
