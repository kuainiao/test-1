        ...
        $('#container').highcharts({
            ...
            xAxis: {
				title:{text:'日期',align: 'high'},
                 categories:  [<?php foreach($last_7day_new_user as $v) :?>
            ...
            series: [{
                name: '人数',
                   data: [<?php foreach($last_7day_new_user as $v) :?>
                       <?php echo $v->number.',';?>
                       <?php endforeach;?>]
            }]
        });
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 日新增用户</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/daily_new_user');?>/"+start_date+"/"+stop_date+"/"+server+"/"+channel+"/"+system+"/";
                        });
                    </script>
                </div>
