    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 日新增充值用户</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/daily_addpay_user');?>/"+start_date+"/"+stop_date+"/"+server+"/"+channel+"/"+system+"/";
                        });
                    </script>
                </div>
