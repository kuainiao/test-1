    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 月收益统计</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            window.location.href="<?php echo site_url('gindex/month_return');?>/"+start_date+"/"+stop_date+"/"+server+"/"+channel+"/"+system+"/";
                        });
                    </script>
                </div>
