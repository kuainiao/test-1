...
$(function () {
        $('#container').highcharts({
            ...
            title: {
                text: <?php echo "'".$ser.'流失用户数'."'"; ?>
            },
          
            xAxis: {
				title:{text:'等级',align: 'high'},
                 categories:  [<?php foreach($level_arr as $k=>$v) :?>
                     <?php echo "'".$k."',";?>
                     <?php endforeach;?>],
				labels: {
					rotation: 0,
            ...
            series: [{
                name: '流失用户数',
                   data: [<?php foreach($level_arr as $v) :?>
                       <?php echo $v.',';?>
                       <?php endforeach;?>]
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-list-alt"></i> 流失等级</h2>
                <div style="float:right; font-size:12px; margin-right:10px;">
                    ...
                    <script>
                        $('#submitBtn').click(function(){
                            ...
                            var date = $('#date').val();
                            window.location.href="<?php echo site_url('gindex/loss_level');?>/"+date+"/"+server+"/";
                        });
                    </script>
                </div>
