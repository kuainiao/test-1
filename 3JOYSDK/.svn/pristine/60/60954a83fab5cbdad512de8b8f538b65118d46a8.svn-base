...
<div class="wrap">
  <div class="span1_of_3">
    ...
    <div id="verticalTab" style="margin-top:2px;">
	 ...
	 <form action="pay.php" method="get" id="pay_form">
	  ...
	  <input name="payType" type="hidden" value="alipay" />
       <div class="new_posts" id="tab">
          <div class="vertical_post">
            <div class="yuan-number"> <span class="margin-left10"><?php echo $_GET['orderMoney'];?></span><span>元</span> <a href="#" class="hide_btn"><img src="images/down.png" width="20" height="20"/></a>
              <div class="content">
                <p class="marginf-left10"><span>用户：</span><span><?php echo $_GET['uid'];?></span></p>
                <p class="topdivdeline"><span>商品：</span><span><?php echo $_GET['itemName'];?></span></p>
              </div>
            </div>
            <p class="yuan-tips">确认无误后请到支付宝付款！</p>
            <div class="zhifubox"><a href="javascript:;"  class="zhifubtn" id="sub_pay">去支付宝充值</a></div>
          </div>
        </div>
		 </form>
      </div>
	 ...
	 <div class="resp-tabs-container" style="display:none;">
       ...
       <div class="new_posts" id="tab">
          <div class="vertical_post">
            ...
            <div> </div>
            <div>
			<form action="pay.php" method="get" id="card_form" class="form1">
	  <input name="partner" type="hidden" value="<?php echo $_GET['partner'];?>" />
      <input name="gameId" type="hidden" value="<?php echo $_GET['gameId'];?>" />
      <input name="cpInfo" type="hidden" value="<?php echo $_GET['cpInfo'];?>" />
	  <input name="orderMoney" type="hidden" value="<?php echo $_GET['orderMoney'];?>" />
	  ...
	  <input name="payType" type="hidden" value="szpay" />
              <select  style="width:40%;" name="cardTypeCombine">
                ...
                <br />
                <input type="text"  placeholder="卡号：请输入充值卡号" value="" maxlength="25" id="search_text" name="cardNum" />
                <input type="password" placeholder="密码：请输入充值卡密码" value="" maxlength="25" id="search_text1" name="cardPwd" />
                <input type="submit" value="立即充值" class="zhifubtn" style=" color:#FFFFFF; line-height:40px; height:40px; cursor:pointer; font-weight:700; width:99%;"/>
              </form>
            </div>
          </div>
        </div>
	  ...
	  <input name="payType" type="hidden" value="coin" />
        <div class="new_posts" id="tab">
          <div class="vertical_post">
            <div class="shanbibox">
              <div class="shanbinumber">闪币余额：<span>0闪币</span></div>
              <a href="#" class="refrush">刷新</a> </div>
            <div class="clear"></div>
            <div class="yuan-number"> <span class="margin-left10"><?php echo $_GET['orderMoney'];?></span><span>元</span> <a href="#" class="hide_btn"><img src="images/down.png" width="20" height="20"/></a>
                <div class="content">
                <p class="marginf-left10"><span>用户：</span><span><?php echo $_GET['uid'];?></span></p>
            ...
            <div class="zhifubox"><a href="javascript:showBg2();" class="zhifubtn" id="sub_coin" >立即充值</a></div>
          </div>
        </div>
      </div>
	  </form>
